...
function st.requestNamedPtfxAsset(ptFxName, timeout)
    ...
    return st.streamingRequest(RequestNamedPtfxAsset, HasNamedPtfxAssetLoaded, 'ptFxName', ptFxName, timeout)
end

return st.requestNamedPtfxAsset
