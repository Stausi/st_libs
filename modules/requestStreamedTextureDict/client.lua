...
function st.requestStreamedTextureDict(textureDict, timeout)
    ...
    return st.streamingRequest(RequestStreamedTextureDict, HasStreamedTextureDictLoaded, 'textureDict', textureDict, timeout)
end

return st.requestStreamedTextureDict
