...
local table = st.table

---@param key? string
function st.locale(key)
    local lang = key or st.getLocaleKey()
...
---@param key string
---@return string?
function st.getLocale(resource, key)
...
---Backing function for st.getLocale.
---@param key string
---@return string?
...
AddEventHandler('st_libs:setLocale', function(key)
    st.locale(key)
end)
