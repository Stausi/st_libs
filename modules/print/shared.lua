...
local resourcePrintLevel = printLevel[GetConvar('st:printlevel:' .. cache.resource, GetConvar('st:printlevel', 'info'))]
...
---Prints to console conditionally based on what st:printlevel is.
---Any print with a level more severe will also print. If st:printlevel is info, then warn and error prints will appear as well, but debug prints will not.
