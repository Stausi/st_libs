...
function st.requestAnimDict(animDict, timeout)
    ...
    return st.streamingRequest(RequestAnimDict, HasAnimDictLoaded, 'animDict', animDict, timeout)
end

return st.requestAnimDict
