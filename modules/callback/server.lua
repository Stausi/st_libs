...
local function triggerClientCallback(_, event, playerId, cb, ...)
    ...
    TriggerClientEvent('st_libs:validateCallback', playerId, event, cache.resource, key)
